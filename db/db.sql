...
-- Query to vds
SELECT * FROM vds WHERE vds.id = 1;
SELECT * FROM vds WHERE vds.note ILIKE '%fun%';
SELECT * FROM vds WHERE vds.ip ILIKE '%123.%';
SELECT * FROM vds WHERE vds.login ILIKE '%logi%';
SELECT * FROM vds WHERE vds.password ILIKE '%s_1%';

SELECT * FROM vds WHERE vds.activated BETWEEN
  '2012-04-01 23:55:00' :: TIMESTAMP AND
  '2018-04-17 12:57:15.449000' :: TIMESTAMP;

SELECT * FROM vds WHERE deactivated BETWEEN
'2012-04-01 23:55:00' :: TIMESTAMP AND
'2018-04-17 12:57:15.449000' :: TIMESTAMP;

-- Query for phone
SELECT * FROM phone WHERE id = 1;
SELECT * FROM phone WHERE phone.number ILIKE '%+7890%';
SELECT * FROM phone WHERE phone.operator_url ILIKE '%bee%';
SELECT * FROM phone WHERE phone.operator_login ILIKE '%test%';
SELECT * FROM phone WHERE phone.operator_pass ILIKE '%pass%';
SELECT * FROM phone WHERE phone.operator_name ILIKE '%ee%';
SELECT * FROM phone WHERE phone.status = 'Active';
SELECT * FROM phone WHERE phone.note ILIKE '%e N%';

SELECT * FROM phone WHERE phone.reg_date BETWEEN
'2012-04-01 23:55:00' :: TIMESTAMP AND
'2018-04-17 12:57:15.449000' :: TIMESTAMP;
